...
class UserCreate(BaseModel):
    ...
    gender: Optional[str] = Field(None, regex=r"^[MFO]?$", description="Gender (M/F/O)")
...
class TransactionCreate(BaseModel):
    ...
    transaction_type: Optional[str] = Field(None, regex=r"^(INCOME|EXPENSE|INVESTMENT)?$", description="Type")
    payment_method: Optional[str] = Field(None, regex=r"^(CARD|BANK_TRANSFER|CASH|CHECK)?$", description="Payment method")
...
class GoalCreate(BaseModel):
    ...
    status: str = Field("ACTIVE", regex=r"^(ACTIVE|COMPLETED|ABANDONED)$", description="Status")
    priority: Optional[str] = Field(None, regex=r"^(LOW|MEDIUM|HIGH)?$", description="Priority")
